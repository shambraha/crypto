...
from main.caculate_weeks import normalize_min_max, normalize_z_score
from main.caculate_weeks import method_descriptions
from main.caculate_weeks import compare_weeks, compare_with_all_weeks
...
# 1. Compare first_week  và second_week
# 2. Compare first_week và all_week
# có kèm tuỳ chọn normalize và tuỳ chọn phương pháp so sánh