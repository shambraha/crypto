...
# Tạo thêm cột Label vì ngựa ngựa dự đoán theo kiểu Label
...
# print("Thông tin về ModelManager Regression: \n", MM_Regression)
...
for inputs, targets in train_loader:
    ...
    # criterion=torch.nn.MSELoss() # không nên dùng MSE cho nhi phân

    # outputs = torch.sigmoid(outputs)
    # criterion = torch.nn.BCELoss() # dùng cái này phải sigmod outputs

    criterion = torch.nn.BCEWithLogitsLoss() # dùng cái này phải chỉnh lại shape
...
# best_path = r"E:\MyPythonCode\Crypto\notebooks\models\best-LSTM_Regression-20240925-232135.pth"
# MM_Regression.load_model(best_path)
# #6.2 Tiếp tục huấn luyện mô hình
# MM_Regression.train(num_epochs=50, save_dir='models')
# #endregion

# Ghi chú
# làm thêm trường hợp đổi labels từ 0-1 thành giá trị y tiếp theo để cho nó dự đoán như bình thường
